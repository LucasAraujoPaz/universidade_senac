...
public class Repositorio {
	...
	public synchronized static <T> T realizarOperacaoAtomica(
			Function<Repositorio, T> funcao) {
		
		return funcao.apply(instance);
	}

	public <T extends EntidadeComId> T criar(T entidade, Caminho caminho) {
	...
	public <T> T obter(long id, Caminho caminho, Class<T> classe) {
	...
	public <T> List<T> listar(Caminho caminho, Class<T> classe) {
	...
	public <T extends EntidadeComId> T atualizar(T entidade, Caminho caminho) {
	...
	public void deletar(long id, Caminho caminho) {
